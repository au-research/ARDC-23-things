...
author: ANDS
description: |
    Research data comes in many shapes and sizes and its management changes
    over time. Kick off your research data journey by exploring different
    types and forms of research data and how they fit into the research
    lifecycle.
...
og:description: |
    ...
    lifecycle.
og:site_name: ANDS
og:title: 'Medical &amp; health Thing 1: Getting started with research data'
og:type: website
og:url: 'https://www.ands.org.au/working-with-data/skills/23-research-data-things/10-medical-and-health-things/m-and-h-thing-1'
robots: 'index,follow'
title: 'Medical & health Thing 1: Getting started with research data - ANDS'
viewport: |
...
[]{#content}
Medical & health Thing 1: Getting started with research data
============================================================
...
<div id="content_container_583598">
...
![](https://www.ands.org.au/__data/assets/image/0007/584845/Activity-1-button.png){#t1-activity1 width="145" height="46"} What research data are we talking about?
------------------------------------------------------------------------------------------------------------------------------------------------------------------

1.  Read the *[Defining Research
    Data](https://library.uoregon.edu/datamanagement/datadefined "Defining research data")*
    section from University of Oregon library
2.  As we have just seen, research data can come in many forms. Some of
    these are human readable, and some are machine readable. Explore a
    couple of these types of formats commonly used for medical, clinical
    and health data:
    1.  [images](https://abctb.org.au/abctbNew2/researchspecimenquery.aspx)
    2.  [clinical trial data](https://clinicalstudydatarequest.com/)
    3.  [questionnaires](http://www.icpsr.umich.edu/icpsrweb/NACDA/studies/2760)
    4.  [interviews](http://healthtalkaustralia.org/)
    5.  [genetic sequences](http://www.ncbi.nlm.nih.gov/nucleotide/)

**Consider:** make a list of the forms of data you have used or seen in
your work. What would people need to know about these data if they
wanted to re-use these data?

![](https://www.ands.org.au/__data/assets/image/0008/584846/Activity-2-button.png){#t1-activity2 width="145" height="46"} Data in the research lifecycle
--------------------------------------------------------------------------------------------------------------------------------------------------------
...
A data lifecycle shows the different phases a dataset goes through as
the research project moves from "having a brilliant idea" to "making
groundbreaking discoveries" to "telling the world about it"

1.  Take a look at either:
    1.  [UK Data Archive Research Data
        Lifecycle](http://www.data-archive.ac.uk/create-manage/life-cycle)(if
        you are new to this concept)
    2.  [DCC Curation Lifecycle
        Model](http://www.dcc.ac.uk/resources/curation-lifecycle-model)
        (if you are familiar with this concept)
2.  Have a look at the [NHMRC Open Access
    ...
    (Section 4.2 and Appendix 2) and note the lifecycle diagram for data
    sharing

**Consider**: have you been through all of the steps outlined in this
lifecycle? If not, which ones are new to you?

![](https://www.ands.org.au/__data/assets/image/0009/584847/Activity-3-button.png){#t1-activity3 width="145" height="46"} How data differs across disciplines
-------------------------------------------------------------------------------------------------------------------------------------------------------------

1\. Choose one of the three specialised data repositories below, or find
...
2.  [Australian Data Archive](https://www.ada.edu.au/) (this archive
    contains Social Science, Historical, Indigenous, Longitudinal,
    Qualitative, Crime & Justice and International data)
3.  [USGS Water Data](http://waterdata.usgs.gov/nwis)

2\. Think about how the data here differs from data you are familiar
with. Consider for example, format, size and access method.

**Consider** how cross disciplinary research could be affected by
discipline data conventions, and also one way cross disciplinary data
access can be facilitated.

</div>

<div id="new_content_container_703425">
...
![thing21 credly
badge](https://www.ands.org.au/__data/assets/image/0011/703487/M-And-H-Thing-1.png)

</div>

Completion of M&H Thing 1 means you've earned a digital badge!

[Claim your badge](https://credly.com/claim/96089/565-F9DA-60F)

Go to [M&H Thing
2:](https://www.ands.org.au/working-with-data/skills/23-research-data-things/10-medical-and-health-things/m-and-h-thing-2)
Issues in research data management or [All M&H
Things](https://www.ands.org.au/working-with-data/skills/23-research-data-things/10-medical-and-health-things)
