...
author: ANDS
description: |
    Metadata elements are the lifeblood for finding and reusing research
    data. Data is only as valuable as the metadata which describes and
    connects it. In addition to selecting a metadata standard or schema,
    whenever possible you should also use a controlled vocabulary. A
    controlled vocabulary provides a consistent way to describe data.
...
og:site_name: ANDS
og:title: |
    Medical &amp; health Thing 9: Describing data: metadata and controlled
    vocabularies
og:type: website
og:url: 'https://www.ands.org.au/working-with-data/skills/23-research-data-things/10-medical-and-health-things/m-and-h-thing-9'
robots: 'index,follow'
title: |
    Medical & health Thing 9: Describing data: metadata and controlled
    vocabularies - ANDS
...
[]{#content}
Medical & health Thing 9: Describing data: metadata and controlled vocabularies
===============================================================================
...
<div id="content_container_583630">
...
![](https://www.ands.org.au/__data/assets/image/0007/584845/Activity-1-button.png){#t9-activity1 width="145" height="46"} Metadata: your new best friend
--------------------------------------------------------------------------------------------------------------------------------------------------------

Metadata is structured information about a resource that describes
characteristics such as content, quality, format, location and contact
information. Creating metadata to describe research data is very similar
to the process for descriptive cataloguing of library resources. 
...
1\. Start by watching this short (2:29 min)
[video](https://youtu.be/TPRz4IEZPww) about medical metadata

2\. Read the short ANDS [Introduction to
Metadata](https://www.ands.org.au/working-with-data/metadata) to
understand what metadata is and why is it the lifeblood of research data
sharing!

3\. Let’s revisit at least one of the good quality metadata records for
medical data we met in previous Things. Why do you think these records
are considered ‘good quality’?  Hint: consider both the type and quality
of information provided. What metadata included in this record help
discovery and reuse of the data?

-   [The Australian Longitudinal Study of Ageing: Wave 1,
    1992](http://www.ada.edu.au/ada/01083-wave1)
-   [National Survey of Midlife Development in the United States
    (MIDUS)](http://doi.org/10.3886/ICPSR02760.v11)
-   [Population Health data collection for the City of Greater
    Bendigo](http://hdl.handle.net/1959.9/532883)

**If you have time,** explore the UK Digital Curation Center’s
[Directory of Disciplinary
Metadata](http://www.dcc.ac.uk/resources/metadata-standards). You might
find a schema that is applicable to your research!
...
![](https://www.ands.org.au/__data/assets/image/0008/584846/Activity-2-button.png){#t9-activity2 width="145" height="46"} Control your language, please!
--------------------------------------------------------------------------------------------------------------------------------------------------------

Controlled vocabularies significantly improve data discovery. They make
...
e.g. medical conditions, plants, animals etc. There are hundreds of
controlled vocabularies used in medical practice, many of which can be
utilised in research.

1.  Explore one of the following:
    -   [ICD-10](http://www.who.int/classifications/icd/en/) for
        classification of diseases
    -   [RxNorm](https://www.nlm.nih.gov/research/umls/rxnorm/) for
        clinical drugs (US based, so has US spelling and brand names)
    -   [SNOMED-CT](http://www.ihtsdo.org/snomed-ct/what-is-snomed-ct)
        for clinical terminology, which has an Australian version,
        [SNOMED-CT-AU](https://www.healthterminologies.gov.au/ "National Clinical Terminology Service")
    -   [MeSH](https://www.nlm.nih.gov/mesh/meshhome.html) for medical
        subject headings (particularly useful for making your research
        more findable in literature searches)
2.  Have a flick through these [slides about health
    vocabularies](http://www.slideshare.net/AustralianNationalDataService/controlled-vocabularies-for-medical-and-health-research)

**Consider:** How would the use of a controlled vocabulary be helpful
within your field?

</div>

<div id="new_content_container_703666">
...
![M&H Thing
9](https://www.ands.org.au/__data/assets/image/0003/703479/M-And-H-Thing-9.png)

</div>

Completion of M&H Thing 9 means you've earned a digital badge!

[Claim your badge](https://credly.com/claim/96719/2DE-24BA-ED0)

Go to [M&H Thing
10:](https://www.ands.org.au/working-with-data/skills/23-research-data-things/10-medical-and-health-things/m-and-h-thing-10)Planning
to publish or [All M&H
Things](https://www.ands.org.au/working-with-data/skills/23-research-data-things/10-medical-and-health-things)
